					...
					echo '<div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">';
						echo '<div class="blog-item bg-light rounded overflow-hidden">';
							echo '<div class="blog-img position-relative overflow-hidden">';
								echo '<a href="' . base_url(sprintf('blog/%s', $arrBlogEntry->url)) . '"><img class="img-fluid" src="'. base_url(sprintf('%s/%s',  FEATURED_IMAGE_PATH, $arrBlogEntry->image)) .'" alt="' . $arrBlogEntry->title . '"></a>';
							...
							echo '<div class="p-4">';
								...
								echo '</div>';
								echo '<h4 class="mb-3"><a href="' . base_url(sprintf('blog/%s', $arrBlogEntry->url)) . '">' . $arrBlogEntry->title . '</a></h4>';
