	...
	<div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
		<div class="carousel-inner">
			<div class="carousel-item active">
				<video class="elementor-background-video-hosted elementor-html5-video" autoplay="" muted="" playsinline="" loop="" src="<?php echo base_url('assets/videos/pressure-washing-sidewalk.mov', BASE_URL_PROTOCOL); ?>" style="width: 1903px;"></video>
...
<!--						<a href="quote.html" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Free Quote</a>-->
			...
			<div class="carousel-item">
				<video class="elementor-background-video-hosted elementor-html5-video" autoplay="" muted="" playsinline="" loop="" src="<?php echo base_url('assets/videos/pressure-washing-concrete.mov', BASE_URL_PROTOCOL); ?>" style="width: 1903px;"></video>
				<div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
					<div class="p-3" style="max-width: 900px;">
