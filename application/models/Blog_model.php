	...
	public function __construct()
	{
		$this->Post = [
			[
				...
				'image'     => base_url(sprintf('%sbest-time-to-clean-your-homes-exterior-and-driveway.jpg', self::FEATURED_IMAGE_PATH)),
			...
			[
				...
				'image'     => base_url(sprintf('%sget-your-home-ready-for-spring-with-professional-pressure-washing-services.jpg', self::FEATURED_IMAGE_PATH)),
			...
			[
				...
				'image'     => base_url(sprintf('%sthe-importance-of-regular-home-washing-and-driveway-cleaning-protecting-your-investment.jpg', self::FEATURED_IMAGE_PATH)),
				'blurb'     => 'Spring is the perfect time to give your home a fresh start, and what better way to do that than with a thorough spring cleaning?',
				'category' 	=> 'Seasonal'
			],
			[
				...
				'image'     => base_url(sprintf('%swhy-super-suds-for-driveway-and-concrete-cleaning.jpg', self::FEATURED_IMAGE_PATH)),
			...
			[
				...
				'image'     => base_url(sprintf('%sgrim-to-shine-5-reasons-why-you-need-a-pressure-washer.jpg', self::FEATURED_IMAGE_PATH)),
