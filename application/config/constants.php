...
defined('GOOGLE_EMAIL') 	OR define('GOOGLE_PASS', 'brian@supersuds.net');
defined('GOOGLE_PASS') 		OR define('GOOGLE_PASS', '&L20Y*qLd@6&');

defined('META_IMAGE_DIRECTORY') 		OR define('META_IMAGE_DIRECTORY', 'meta-images');
defined('FEATURED_IMAGE_PATH') 			OR define('FEATURED_IMAGE_PATH', 'assets/img/featured-post-images');
